...
<body>
  ...
  <section class="main-img hero">
    <div class="hero-block _container _indent">
      <div class="hero-text">
        <h1 class="hero-title">{!! $blocks->get('indexes_title') !!}</h1>
        <p class="hero-subtitle">
          {!! $blocks->get('indexes_description') !!}
        </p>
      </div>
      <div class="hero-img">
        <img src="/assets/img/indices-main.png" alt="iPhone" />
      </div>
    </div>
  </section>
  ...
  <section class="improvement _container _indent">
    <div class="improvement__container">
      <h1 class="improvement__title">
        {!! $blocks->get('indexes_trade_indices') !!}
      </h1>
      <p class="improvement__description">
        {!! $blocks->get('indexes_global_access') !!}
      </p>
    </div>
  </section>
  ...
  <section class="_indent info">
    <div class="info-block _container">
      <div class="text-block">
        <h2 class="title">{!! $blocks->get('indexes_what_is') !!}</h2>
      </div>
      <div class="info-part">
        <div class="info-block__card">
          {!! $blocks->get('indexes_definition') !!}
        </div>
        <img class="desktop" src="/assets/img/mob-info.png" alt="" />
        <div class="info-block__card">
          {!! $blocks->get('indexes_trading_benefits') !!}
        </div>
